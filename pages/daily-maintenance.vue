...
import FaqTwoColumn from "./_components/faq/FaqTwoColumn.vue";
import MaintenanceTimer from "./_components/MaintenanceTimer.vue";
...
const content: FaqContent[] = [
  {
    ...
    answer: `The maintenance of the Albion servers lasts an <strong>average of 30 to 60 minutes per day</strong>. During
  ...
  },
  {
    ...
    answer: `The world of Albion is running on a single server, as explained on the
  ...
  },
  {
    ...
    answer: `The maintenance is taking place from <strong>10am to 11am UTC</strong> every day.
      The total duration can vary though as explained above.`,
  },
  {
    question: "What happens during the maintenance?",
    answer: `During the daily server maintenance, there are a couple of technical tasks to fulfill.
...
<template>
  <FaqTwoColumn :content="content">
    <template #heading>
      <Heading> Daily Maintenance of the Albion Online Servers </Heading>
    </template>
    <template #intro>
      <p class="pt-8">
        The daily maintenance is an important part of Albion Online. Every player should be aware of
        it. Nothing is more annoying then trying to play the game and see that the maintenance is
        ongoing. Luckily, our
        <Link class="underline hover:no-underline inline-block text-gray-800" href="/">
          server status tracker
        </Link>
        will tell you when the servers are back online.
        <br /><br />
        Below, you'll find information regarding the duration, timing and purpose of the daily
        server maintenance. As a bonus, there is a
        <a class="underline hover:no-underline inline-block text-gray-800" href="#timer">timer</a>

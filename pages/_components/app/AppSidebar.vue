...
import AdWrapperSidebar from "../ad/AdWrapperSidebar.vue";
...
interface NavLink {
  name: string;
  icon: {
    props: { fill: string; viewBox: string };
    path: {
      d: string;
      "clip-rule"?: "evenodd";
      "fill-rule"?: "evenodd";
...
const links: NavLink[] = [
  {
    ...
    to: "/",
    icon: {
      props: { fill: "currentColor", viewBox: "0 0 20 20" },
      path: {
...
function authorizePushNotifications() {
  try {
